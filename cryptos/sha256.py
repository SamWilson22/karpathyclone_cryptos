"""
Follows the FIPS PUB 180-4 description for calculating SHA-256 hash funciton 
https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.180-4.pdf

Noone in their right mind should use this for any serious reason. This was written
purely for educationsl purposes.
"""
...
def genH():
    """
    Follows Section 5.3.3 to generate the initial hash value of H^0
...
def pad(b):
    ...
    b = bytearray(b) # converss to a mutable equivalent
